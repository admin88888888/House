...
public class AliyunSmsUtil {
    ...
    public static boolean sendSms(String phone, int code) {
        DefaultProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAIU5ukxB5lOe97", "ciLrrdwBEoDiA62TTVuZQpDiOejBit");
        ...
        request.putQueryParameter("SignName", "租不出户");
        request.putQueryParameter("TemplateCode", "SMS_164505173");
